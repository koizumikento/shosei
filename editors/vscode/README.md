...
```text
editors/vscode/shosei-vscode-0.2.1.vsix
```
...
```text
shosei-vscode-0.2.1.vsix
shosei-v0.2.1-x86_64-unknown-linux-gnu.tar.gz
shosei-v0.2.1-x86_64-apple-darwin.tar.gz
shosei-v0.2.1-aarch64-apple-darwin.tar.gz
