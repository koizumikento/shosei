...
| Delivery validation | supported with opt-in depth | local lint、`epubcheck`、`qpdf`、opt-in Kindle Previewer conversion check を `validators[]` に記録 |
| Handoff package | supported | artifact、`reports/validate.json`、`manifest.json`、proof review packet、editorial sidecar を package 化 |
