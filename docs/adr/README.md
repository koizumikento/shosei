...
- [ADR-0027: prose の default design は scaffolded stylesheet で持ち、build 時に適用する](0027-prose-default-design-lives-in-scaffolded-stylesheets.md)
- [ADR-0028: 縦組み prose print は Chromium backend を使う](0028-vertical-prose-print-uses-chromium.md)
